---
name: ccf-artifact-packager
description: "Prepare artifact and reproducibility packages: code/data/model release plan, environment, seeds, hardware notes, README structure, licenses, and reproducibility appendix. Use for artifact evaluation and reproducibility planning. Do not claim unavailable releases."
metadata:
  ccf_skill_controls:
