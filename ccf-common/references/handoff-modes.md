...
- `ccf-pipeline-orchestrator` evidence-plan mode must never invent experimental results, method ranks, numerical improvements, statistical significance, or user-study outcomes.
