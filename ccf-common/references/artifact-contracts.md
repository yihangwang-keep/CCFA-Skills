...
| `experiment-debug/*.md` | `ccf-experiment-debugger` | Stores failure signatures, environment/algorithm auditor evidence, confirmed owner, minimal versioned change, invalidated gates, and rerun closure. It preserves original failed results. |
