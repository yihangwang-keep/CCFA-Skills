...
| `environment-audit/*.md` | `ccf-env-code-auditor` | Stores document-to-code traceability, scientific-problem fidelity and tradeoff-probe evidence, brief findings, and the environment verdict. Repairs remain with the invoking phase owner. |
| `algorithm-audit/*.md` | `ccf-algorithm-code-auditor` | Stores equation-to-code traceability, semantic and execution-flow evidence, brief findings, and the algorithm verdict. Repairs remain with the invoking phase owner. |
