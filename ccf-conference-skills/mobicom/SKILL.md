---
name: mobicom
description: Writing and formatting guidance for MobiCom (ACM Conference on Mobile Computing and Networking) papers. Use when drafting, formatting, or submitting to MobiCom 2026. Covers ACM acmart sigconf format with anonymous review mode, mobile/wireless paper conventions (system design, real-world evaluation, sensing and communication), 12-page limit, and camera-ready preparation.
metadata:
  ccf_skill_controls:
