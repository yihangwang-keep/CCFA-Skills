---
name: stoc
description: Writing and formatting guidance for STOC (ACM Symposium on Theory of Computing) papers. Use when drafting, formatting, or submitting to STOC 2026. Covers ACM acmart sigplan format with double-blind review mode, STOC page limits (12 pages), theory-specific conventions (theorem/proof structure, reduction-based proofs, lower bounds), and ACM camera-ready preparation.
---
