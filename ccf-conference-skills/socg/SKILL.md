---
name: socg
description: Writing and formatting guidance for SoCG (Symposium on Computational Geometry) papers. Use when drafting, formatting, or submitting to SoCG 2026. Covers LIPIcs/socg-lipics class with line numbering, anonymous submission mode, geometry-specific conventions (theorems, proofs, figures), page limits, and camera-ready requirements.
metadata:
  ccf_skill_controls:
