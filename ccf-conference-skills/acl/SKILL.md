---
name: acl
description: Writing and formatting guidance for ACL (Association for Computational Linguistics) conference papers. Use when drafting, formatting, or submitting papers to ACL 2026. Covers the acl.sty class with review/final/preprint modes, Times font and microtype setup, title box adjustment for oversized headers, natbib citation commands, appendix formatting, and double-blind anonymity rules. This skill applies equally to EMNLP, NAACL, COLING, and CoNLL which share the same acl.sty template.
---
