---
name: infocom
description: Writing and formatting guidance for INFOCOM (IEEE Conference on Computer Communications) papers. Use when drafting, formatting, or submitting to INFOCOM 2026. Covers IEEEtran.cls with conference mode, networking paper conventions (protocol design, evaluation methodology, network simulations, security analysis), double-blind anonymity, 12-page limit, and camera-ready preparation.
---
