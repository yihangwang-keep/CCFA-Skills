---
name: tcc
description: Writing and formatting guidance for TCC (Theory of Cryptography Conference) papers. Use when drafting, formatting, or submitting to TCC 2026. Covers Springer LNCS llncs.cls format with splncs04 bibliography style, double-blind anonymity, 30-page limit (LNCS standard), theoretical cryptography, complexity-based security, and camera-ready preparation.
---
