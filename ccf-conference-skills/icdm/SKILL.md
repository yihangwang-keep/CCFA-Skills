---
name: icdm
description: Writing and formatting guidance for ICDM (International Conference on Data Mining) papers. Use when drafting, formatting, or submitting to ICDM 2026. Covers IEEEtran conference format with double-column layout, page limits, IEEE citation style, data mining-specific conventions, theorem environments, and camera-ready requirements.
---
