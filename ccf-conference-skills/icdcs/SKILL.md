---
name: icdcs
description: Writing and formatting guidance for ICDCS (International Conference on Distributed Computing Systems) papers. Use when drafting, formatting, or submitting to ICDCS 2026. Covers IEEEtran conference class, distributed systems-specific conventions, page limits, and camera-ready preparation with IEEE Xplore metadata.
---
