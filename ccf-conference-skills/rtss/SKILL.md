---
name: rtss
description: Writing and formatting guidance for RTSS (IEEE Real-Time Systems Symposium) papers. Use when drafting, formatting, or submitting to RTSS 2026. Covers IEEEtran LaTeX class with conference mode, RTSS page limits (10 pages), double-blind anonymity, real-time-specific conventions (schedulability analysis, worst-case execution time, timing guarantees), and IEEE camera-ready preparation.
---
