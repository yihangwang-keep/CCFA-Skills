---
name: raid
description: Writing and formatting guidance for RAID (International Symposium on Research in Attacks, Intrusions and Defenses) papers. Use when drafting, formatting, or submitting to RAID 2026. Covers Springer LNCS llncs.cls format with splncs04 bibliography style, double-blind anonymity, 30-page limit (LNCS standard), intrusion detection, attack analysis, and camera-ready preparation.
---
