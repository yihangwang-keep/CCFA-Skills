---
name: icpp
description: Writing and formatting guidance for ICPP (International Conference on Parallel Processing) papers. Use when drafting, formatting, or submitting to ICPP 2026. Covers ACM acmart sigconf format with anonymous review mode, parallel computing-specific conventions, page limits, and camera-ready preparation.
---
