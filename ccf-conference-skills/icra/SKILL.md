---
name: icra
description: Writing and formatting guidance for ICRA (IEEE International Conference on Robotics and Automation) papers. Use when drafting, formatting, or submitting to ICRA 2026. Covers IEEEtran.cls conference format, double-blind anonymity with peerreviewca mode, page limits, reference formatting with IEEEtran BibTeX style, robotics and automation research conventions, and camera-ready preparation. ICRA is a CCF-B robotics conference published by IEEE.
metadata:
  ccf_skill_controls:
