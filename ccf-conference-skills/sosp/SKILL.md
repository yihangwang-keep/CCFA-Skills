---
name: sosp
description: Writing and formatting guidance for SOSP (ACM Symposium on Operating Systems Principles) papers. Use when drafting, formatting, and submitting to SOSP 2026. Covers ACM acmart sigplan format with anonymous review mode, SOSP's writing conventions (motivation, design, implementation, evaluation sections), page limits (14 pages), camera-ready metadata, double-blind submission requirements, and systems-specific evaluation standards.
---
