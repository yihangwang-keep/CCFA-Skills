---
name: sigcomm
description: Writing and formatting guidance for SIGCOMM (ACM SIGCOMM Conference) papers. Use when drafting, formatting, or submitting to SIGCOMM 2026. Covers ACM acmart sigconf format with anonymous review mode, networking paper conventions (protocol design, formal analysis, network measurements, real-world deployment), 14-page limit, and camera-ready preparation.
metadata:
  ccf_skill_controls:
