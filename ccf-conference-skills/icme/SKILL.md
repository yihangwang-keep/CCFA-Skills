---
name: icme
description: Writing and formatting guidance for ICME (IEEE International Conference on Multimedia and Expo). Use when drafting, formatting, or submitting papers to ICME 2026. Covers IEEEtran conference class, double-blind review requirements, 6-page limit, reference formatting, figure/table placement, Times font requirements, and camera-ready submission via the IEEE submission system.
---
