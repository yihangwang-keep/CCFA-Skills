---
name: wsdm
description: Writing and formatting guidance for WSDM (Web Search and Data Mining) conference papers. Use when drafting, formatting, or submitting to WSDM 2026. Covers ACM acmart sigconf format, double-blind anonymity with review mode, page limits, reference formatting with natbib and ACM-Reference-Format, and camera-ready metadata (DOI/ISBN).
metadata:
  ccf_skill_controls:
