...
> Migrated from the legacy `ccf-conference-skills/cluster/SKILL.md` runtime skill during v0.4.0. This file is now reference material for `ccf-paper-writer` and `ccf-venue-format-guide`, not a standalone skill.
