...
ferentiable model for the camera’s optics is incorporated into a neural network,
...
ual’s privacy while still capturing enough information to perform a task. Some
...
It is known that cameras are power-hungry—the image sensor alone can con-
...
tion using a large dataset of very low resolution (32×32) images. In our experiments,
...
a freeform pixel include the attenuation due to the mask, the detector’s directional
...
this end, we define Mt(x, y), such that M(x, y) = σ(Mt(x, y)), where σ is the
...
noise are added, which can be modeled as Gaussian noise (nr ∼N(0, σ2
r)) and
...
major impact on the final “shape” of a freeform pixel. For instance, a detector’s
...
in the camera’s chassis.3 Each mask is 16×16 mm2 and is placed 11.4 mm above
...
tector’s photocurrent to a voltage. The voltages of the 24 freeform pixels are
...
people, which is comparable to that of a 64×64 baseline camera. This translates
...
privacy, it strongly supports our conjecture that a person’s identity cannot be
...
IEEE Transactions on Computational Imaging 3(3), 384–397 (Sep 2017)
...
Analysis and Machine Intelligence 42(7), 1618–1629 (Jul 2020)
...
cessing Magazine 25(2), 83–91 (Mar 2008)
...
on Computational Imaging 4(3), 298–310 (Sep 2018)
...
lens design using fast differentiable ray tracing. Optics Letters 46(21), 5453–5456
(Nov 2021)
...
Transactions on Pattern Analysis and Machine Intelligence 39(11), 2215–2226 (Nov
2017)
...
Analysis and Machine Intelligence 30(11), 1958–1970 (Nov 2008)
...
photonics. Nature 588(7836), 39–47 (Dec 2020)
