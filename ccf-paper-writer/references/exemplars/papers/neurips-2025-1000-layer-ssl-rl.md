...
(S, A, p0, p, pg, rg, γ), where the agent interacts with the environment to reach arbitrary goals (Kael-
...
steps (out of 1000) that the agent is near the goal. When reporting an algorithm’s performance as a
