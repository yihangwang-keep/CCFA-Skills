...
inflatable dinosaur beside a wall with abstract
trees and a window.
4D LMM: A man in sunglasses lifts a green inflat-
able dinosaur beside a window, showing upward
motion over time against tree-like graffiti.
4D Dense Caption
4D Visual Grounding
4D Question Answering
Q: Which object is the person lifting
up near the wall? Please provide its
coordinates.
3D LMM: The object is a green
inflatable dinosaur. It is at [2.26,
0.54, 0.23, 3.20, 0.21, 0.39].
4D LMM: This object is a green
inflatable dinosaur. At 1s, it is at
[2.25, 0.51, 0.25, 3.18, 0.20, 0.39].
At 2s, it is at [4.32, 1.74, 0.20, 4.89,
1.15, 0.25].
Q: A object is located at [2.60, 0.34, 0.29]. Please describe this object.
3D LMM: A green inflatable dinosaur with striped patterns and stubby
limbs, positioned horizontally and held at the front by a person in plaid.
4D LMM: A shiny green inflatable dinosaur with dark stripes and short
limbs is being held by a person in plaid shirt and lifted upward in front of
a mural wall.
Q: Where is this object likely to go next?
3D LMM: This object is landing on the ground. ❎
4D LMM: This object is moving upward during [1s-2s] and is likely to
reach the window area next.
...
the position of the tiger at each time.
...
Linguistic Time Token
Visual Spatial Token
Visual Temporal Token
...
spatiotemporally encoded into corresponding linguistic tokens τ st
l .
...
A: Two. A fresh salmon
fillet is gently being
cooked in a black pan
and another lies raw on
a white plate.
(a) Overview of Chat4D Dataset
(b) Training Pipeline
...
This projected fused spatiotemporal features is the visual tokens denoted as τ st
v . Subsequently, we
...
User
Video-3D LLM
What does the person do? Please provide its coordinates.
LLaVA-3D
A person is riding a horse, jumping over an obstacle in an outdoor equestrian arena. It is at [11.26, 2.10,
-7.35, 12.48, 0.36, -7.10].
The person is horseback riding in a sandy arena, jumping over a high obstacle during a show jumping com-
...
View 1
Map
w/ 4D Coordinate Embedding
w/ Spatiotemporal Disentangling
Map
Map
Map
Map
...
User
Please segment this dance move.
This person is performing a dance move on a street, spinning on one
hand, and switching leg positions mid-air.
Temporal Action
Sure, [SEG].
User
How many persons in the scene?
User
Please segment these persons.
Four.
Spatial Semantic
