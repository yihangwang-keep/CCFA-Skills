...
tracks, in seconds. (2) We demonstrate that VGGTs pre-
...
Some concur-
rent works [73, 85, 96, 105] explore replacing DUSt3Rs
...
nearby regions. Here, we demonstrate that VGGTs fea-
...
R3HW , observing the same 3D scene. VGGTs trans-
...
Di ∈RHW , its point map Pi ∈R3HW , and a grid
Ti ∈RCHW of C-dimensional features for point track-
...
the cameras principal point is at the image center, which is
...
tracks directly but instead features Ti ∈RCHW , which
...
tI ∈RKC through DINO [53]. The combined set of im-
...
frame-speciﬁcthis is because our AA transformer con-
...
i are
ﬁrst converted to dense feature maps Fi ∈RC′′HW with
...
features Ti ∈RCHW , which serve as input to the track-
...
proportional to the models conﬁdence in the predictions.
...
thermore, our models performance advantage is even more
...
mance gains can likely be attributed to our models multi-
...
tion (global alignmentaround 10 seconds per scene),
...
for our ablation study, as it reﬂects the models joint under-
...
nary accuracy of occlusion predictions; vis
avg, comprising the
...
pretrained VGGT signiﬁcantly enhances CoTrackers per-
formance on the TAP-Vid benchmark [13]. For instance,
VGGTs tracking features improve the vis
...
our models strong performance demonstrates the general-
...
Computer Vision, pages 63016310, 2021. 2
...
and pattern recognition, pages 58285839, 2017. 6, 7
...
Recognition, pages 1314213153, 2023. 8
...
tion (ICRA), pages 25532560. IEEE, 2022. 7, 8
...
computer vision and pattern recognition, pages 80928101,
...
tions of the ACM, 24(6):381395, 1981. 3
...
ceedings, Part IV 11, pages 368381. Springer, 2010. 2
...
ence on computer vision, pages 873881, 2015. 2
...
and pattern recognition, pages 24952504, 2020. 2
...
Pattern Recognition, pages 406413. IEEE, 2014. 6
...
ternational journal of computer vision, 81:155166, 2009.
[43] Vincent Leroy,
Yohann Cabon,
and J´erˆome Revaud.
...
puter vision and pattern recognition, pages 35043515,
...
the IEEE/CVF conference on computer vision and pattern
recognition, pages 86458654, 2022. 2
...
sion, pages 1217912188, 2021. 3, 5
...
the IEEE/CVF conference on computer vision and pattern
recognition, pages 49384947, 2020. 2, 5, 7
...
recognition, pages 32603269, 2017. 6
...
Vision and Pattern Recognition, pages 1251712526, 2022.
...
graph 2006 papers, pages 835846. 2006. 2
...
In Pro-
ceedings of the IEEE/CVF conference on Computer Vision
and Pattern Recognition, pages 89538962, 2021. 2
...
bundle adjustment. In Computer VisionECCV 2020: 16th
European Conference, Glasgow, UK, August 2328, 2020,
Proceedings, Part I 16, pages 230247. Springer, 2020. 2
...
In Proceedings of
the IEEE/CVF Conference on Computer Vision and Pattern
Recognition, pages 2040620417, 2024. 8
...
Conference on Computer Vision, pages 119. Springer,
