...
Award: Best Paper.
Source: CVPR `https://cvpr.thecvf.com/Conferences/2025/BestPapersDemos`; CVF awards list `https://www.thecvf.com/?page_id=413`.
Primary writing card: `cards/vggt.md`.
Use when: the user explicitly asks for CVPR 2025 best-paper style or asks how VGGT fits official CVPR best-paper context.

## Role In This Skill

VGGT is both:

- a user-custom writing-format exemplar, via `cards/vggt.md`;
- the CVPR 2025 Best Paper, recorded here for venue-award context.
