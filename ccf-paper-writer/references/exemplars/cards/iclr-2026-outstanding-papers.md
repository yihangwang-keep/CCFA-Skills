...
Source: ICLR Blog `https://blog.iclr.cc/2026/04/23/announcing-the-iclr-2026-outstanding-papers/`.
Use when: the user explicitly asks for recent ICLR outstanding-paper style, especially theory-of-transformers or multi-turn LLM evaluation papers.
