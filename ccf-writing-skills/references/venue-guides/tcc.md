...
> Migrated from the legacy `ccf-conference-skills/tcc/SKILL.md` runtime skill during v0.4.0. This file is now reference material for `ccf-writing-skills` and `ccf-conference-guides`, not a standalone skill.
