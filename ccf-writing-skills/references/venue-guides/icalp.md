...
> Migrated from the legacy `ccf-conference-skills/icalp/SKILL.md` runtime skill during v0.4.0. This file is now reference material for `ccf-writing-skills` and `ccf-conference-guides`, not a standalone skill.
...
| Venue family | Theory |
| CCF tier | CCF-B |
| Template path | `ccf-latex-templates/ICALP/llncs.cls` |
| Official URL | https://icalp2026.compute.dela |
