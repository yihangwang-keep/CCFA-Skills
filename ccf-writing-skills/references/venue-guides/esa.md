...
> Migrated from the legacy `ccf-conference-skills/esa/SKILL.md` runtime skill during v0.4.0. This file is now reference material for `ccf-writing-skills` and `ccf-conference-guides`, not a standalone skill.

| Field | Value |
| --- | --- |
| Venue slug | `esa` |
| Venue family | Algorithms |
| CCF tier | CCF-B |
| Template path | `ccf-latex-templates/ESA/llncs.cls` |
| Official URL | https://esa2026.compute.dela |
