...
3. Run a reviewer deduction scan:
   ...
   - venue mismatch.
4. Score the draft. If `ccf-conference-reviewer` was explicitly requested or confirmed after the optional-module gate, use its scientific review rubric, venue style, and calibration files. Otherwise use the venue adapter plus the scoring table below.
