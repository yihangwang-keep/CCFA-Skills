---
name: ccf-paper-project-scaffold
description: "Create a CCF paper project directory, copy or select LaTeX templates, initialize ccfa.yaml, and create artifact folders for manuscript, figures, experiments, reviews, submission checks, and revision ledger. Use for project scaffolding and reproducible paper workspace initialization. Do not generate research content."
metadata:
  ccf_skill_controls:
...
Handoff to `ccf-pipeline-orchestrator` for stage management, `ccf-writing-skills` for manuscript work, and `ccf-submission-checker` for build checks.
