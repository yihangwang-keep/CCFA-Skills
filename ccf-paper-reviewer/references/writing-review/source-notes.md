...
- Use CSPaper-style calibration only as a conceptual model for consistent diagnostic signals; do not report exact percentiles or acceptance probability without a real calibration dataset.
