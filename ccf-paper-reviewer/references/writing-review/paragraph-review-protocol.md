...
1. Role: hook, problem, gap, point, method overview, evidence, limitation, transition, related-work contrast, result interpretation, or summary.
...
4. Logic: whether sentences follow a cause-effect, general-to-specific, point-to-evidence, or contrast structure.
5. Evidence: whether conclusions are supported or need citation/result/qualification.
...
- the paragraph states the central contribution but does not specify the novelty;
- the paragraph states a strong empirical conclusion without a result/table/figure reference;
...
- a limitation or assumption is hidden after a broad conclusion.
