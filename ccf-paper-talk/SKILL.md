---
name: ccf-paper-talk
description: "Convert a completed or near-completed research paper into slides, poster, talk script, elevator pitch, demo narration, Q&A bank, and rehearsal notes. Use for presentation preparation after or near manuscript completion. Do not use for pre-submission scientific review."
metadata:
  ccf_skill_controls:
...
Use `ccf-writing-skills` only if manuscript text itself must be revised.
